package com.bsl.springmvc.controller;
...
import com.bsl.springmvc.form.ProductForm;
...
public class ProductController {
	...
	//http://localhost:8080/SpringMVC/product_retrieve.action?id=1
	@RequestMapping(value="/product_retrieve")
//	public String sendProduct(@RequestParam Long id,Model model) {
		public String sendProduct(HttpServletRequest request,Model model) {
		//使用@RequestParam获取URL路径上？后面的参数，而servlet中是使用Request对象的getParameter()方法
